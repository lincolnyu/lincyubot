...
{
    // https://www.codeproject.com/Articles/1200390/Taming-the-Twitter-API-in-Csharp
    public class Twitter
    {
        ...
        public string GetTweets(string screenName, int count, bool truncated=false)
        {
            // https://stackoverflow.com/questions/43200595/twitter-api-isnt-returning-truncated-text
            string resourceUrl =
            ...
            if (!truncated)
            {
                requestParameters.Add("tweet_mode", "extended");
            }
